...
@ToolParserManager.register_module("dhanishtha-tool-parser")
class DhanishthaToolPhaser(ToolParser):
    ...
    def extract_tool_calls(
        ...
        if self.tool_call_start_token not in model_output:
            ...
            try:
                ...
                # Tool Call
                raw_function_calls = [
                json.loads((match[0] if match[0] else match[1]).encode('utf-8').decode('unicode_escape'))
